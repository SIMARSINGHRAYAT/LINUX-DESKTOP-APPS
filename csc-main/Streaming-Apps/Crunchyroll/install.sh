...
if [ -f "$LOCAL_CHROME_SCRIPT" ]; then
	...
	if curl -fsSL https://github.com/SIMARSINGHRAYAT/LINUX-DESKTOP-APPS/raw/refs/heads/main/csc-main/scripts/install-chrome-streaming-app.sh | sh -s -- io.github.example.CrunchyrollDesktop Crunchyroll https://www.crunchyroll.com/ crunchyroll-desktop Crunchyroll.png; then exit 0; fi
fi
...
curl -fsSL https://github.com/SIMARSINGHRAYAT/LINUX-DESKTOP-APPS/raw/refs/heads/main/csc-main/scripts/install-linux-app.sh | sh -s -- Streaming-Apps/Crunchyroll io.github.example.CrunchyrollDesktop 'Crunchyroll desktop app'
