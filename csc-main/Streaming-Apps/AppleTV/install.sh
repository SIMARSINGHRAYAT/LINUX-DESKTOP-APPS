...
curl -fsSL https://raw.githubusercontent.com/FANCOINBOY/csc/main/scripts/install-linux-app.sh | sh -s -- Streaming-Apps/AppleTV io.github.example.AppleTVDesktop 'Apple TV desktop app'
