...
curl -fsSL https://raw.githubusercontent.com/FANCOINBOY/csc/main/scripts/install-linux-app.sh | sh -s -- Streaming-Apps/MXPlayer io.github.example.MXPlayerDesktop 'MX Player desktop app'
