...
curl -fsSL https://raw.githubusercontent.com/SIMARSINGHRAYAT/LINUX-DESKTOP-APPS/main/csc-main/scripts/uninstall-linux-app.sh | sh -s -- io.github.example.KaggleDesktop
