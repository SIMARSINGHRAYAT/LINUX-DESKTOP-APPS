...
curl -fsSL https://raw.githubusercontent.com/FANCOINBOY/csc/main/scripts/install-linux-app.sh | sh -s -- Top-10-AI-Developer-Apps/GitHub io.github.example.GitHubDesktop 'GitHub desktop app'